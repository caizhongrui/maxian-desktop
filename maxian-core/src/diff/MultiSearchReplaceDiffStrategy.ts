...
// Ported from Kilocode: src/core/diff/strategies/multi-search-replace.ts
// Adapted for tianhe-zhikai-ide
...
export interface DiffStrategy {
	...
	getProgressStatus(toolUse: ToolUse, result?: DiffResult): { icon?: string; text?: string };
}
